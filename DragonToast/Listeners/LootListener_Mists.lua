...
local PATTERN_LOOT_OTHER_MULTI = Utils.BuildPattern(LOOT_ITEM_MULTIPLE or "%s receives loot: %sx%d.")
...
local PATTERN_PUSHED_SELF_MULTI = Utils.BuildPattern(LOOT_ITEM_PUSHED_SELF_MULTIPLE or "You receive item: %sx%d.")
local PATTERN_PUSHED_OTHER = Utils.BuildPattern(LOOT_ITEM_PUSHED or "%s receives item: %s.")
local PATTERN_PUSHED_OTHER_MULTI = Utils.BuildPattern(LOOT_ITEM_PUSHED_MULTIPLE or "%s receives item: %sx%d.")
...
local PATTERN_CREATED_SELF_MULTI = Utils.BuildPattern(LOOT_ITEM_CREATED_SELF_MULTIPLE or "You create: %sx%d.")

-- Item refund patterns
local PATTERN_ITEM_REFUND_SELF = Utils.BuildPattern(LOOT_ITEM_REFUND or "You are refunded: %s.")
local PATTERN_ITEM_REFUND_SELF_MULTI = Utils.BuildPattern(LOOT_ITEM_REFUND_MULTIPLE or "You are refunded: %sx%d.")
...
-------------------------------------------------------------------------------
-- Build loot data (MoP Classic: 17-return GetItemInfo)
-------------------------------------------------------------------------------
...
local function OnChatMsgLoot(_, msg)
    ...
    if itemLink then
        ...
        if not itemLink then
            looter, itemLink, quantity = TryOtherPair(PATTERN_PUSHED_OTHER_MULTI, PATTERN_PUSHED_OTHER)
        end
        if not itemLink then
            looter, itemLink, quantity = TryOtherPair(PATTERN_BONUS_OTHER_MULTI, PATTERN_BONUS_OTHER)
        end
        if itemLink then
            isSelf = false
        end
